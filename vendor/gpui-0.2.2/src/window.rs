...
impl Window {
    pub(crate) fn new(
        ...
        // but must not be mapped into the desktop. This is especially
        // important for tray-only applications: mapping a `show: false`
        // window creates an otherwise invisible taskbar/window-list entry.
        if show {
