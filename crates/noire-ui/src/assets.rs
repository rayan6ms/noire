...
const WINDOW_LIGHT: &str = r##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 680 520" preserveAspectRatio="none"><rect x=".5" y=".5" width="679" height="519" rx="12.5" fill="#404040" stroke="#555555"/></svg>"##;
