...
impl AssetSource for Assets {
    fn load(&self, path: &str) -> Result<Option<Cow<'static, [u8]>>> {
        let bytes: Option<&'static [u8]> = match path {
            ...
            "icons/noire-symbolic.svg" => Some(include_bytes!("../../../icons/noire-symbolic.svg")),
...
const WAVEFORM: &str = r#"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"><path d="M2 12h3l2-8 3 16 3-16 2 12 2-4h5"/></svg>"#;
